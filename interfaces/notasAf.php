    ...
    <div class="dashboard">
      ...
      <div class="abm">
        <div class="consultarAbm">
          <p>Consultar calificaciones - AF</p>
          ...
          <div class="tabla_consulta">
            ...
            if (isset($_GET['dni'])) {
              ...
              $dni = $_GET['dni'];
              $resultado = $consultarNotas->buscarNotasAf($dni);
              echo $resultado;
            }
            ?>
          </div>
        ...
        <div class="agregarAbm">
          ...
          if (isset($_GET['agregar_dni'])) {
            ...
            $resultado = $crearNotas->crearNotasAf(
              $agregarDni,
              $nombre,
              $apellido,
              $carrera,
        ...
        <div class="eliminarAbm">
          <p>Eliminar calificaciones - AF</p>
          <form action="" method="get">
          ...
          if (isset($_GET['eliminarDni'])) {
            ...
            $resultado = $eliminarNotas->eliminarNotasAf($eliminarDni);
            echo $resultado;
          }
          ?>
        </div>
