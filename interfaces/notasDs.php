        ...
        <div class="dashboard">
            ...
            <div class="abm">
                <div class="consultarAbm">
                    <p>Consultar calificaciones - DS</p>
                    ...
                    <div class="tabla_consulta">
                        ...
                        if (isset($_GET['dni'])) {
                            ...
                            $dni = $_GET['dni'];
                            $resultado = $consultarNotas->buscarNotasDS($dni);
                            echo $resultado;
                        }
                        ?>
                    </div>
                ...
                <div class="agregarAbm">
                    ...
                    if (isset($_GET['agregar_dni'])) {
                        ...
                        $resultado = $crearNotas->crearNotasDs(
                            $agregarDni,
                            $nombre,
                            $apellido,
                            $carrera,
                ...
                <div class="eliminarAbm">
                    <p>Eliminar calificaciones - DS</p>
                    <form action="" method="get">
                    ...
                    if (isset($_GET['eliminarDni'])) {
                        ...
                        $resultado = $eliminarNotas->eliminarNotasDs($eliminarDni);
                        echo $resultado;
                    }
                    ?>
                </div>
