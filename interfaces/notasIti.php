        ...
        <div class="dashboard">
            ...
            <div class="abm">
                <div class="consultarAbm">
                    <p>Consultar calificaciones - ITI</p>
                    ...
                    <div class="tabla_consulta">
                        ...
                        if (isset($_GET['dni'])) {
                            ...
                            $dni = $_GET['dni'];
                            $resultado = $consultarNotas->buscarNotasIti($dni);
                            echo $resultado;
                        }
                        ?>
                    </div>
                ...
                <div class="agregarAbm">
                    ...
                    if (isset($_GET['agregar_dni'])) {
                        ...
                        $resultado = $crearNotas->crearNotasIti(
                            $agregarDni,
                            $nombre,
                            $apellido,
                            $carrera,
                ...
                <div class="eliminarAbm">
                    <p>Eliminar calificaciones - ITI</p>
                    <form action="" method="get">
                    ...
                    if (isset($_GET['eliminarDni'])) {
                        require_once("../php/abm_notas.php");
                        $eliminarNotas = new NotasDB();
                        $eliminarDni = $_GET['eliminarDni'];
                        $resultado = $eliminarNotas->eliminarNotasIti($eliminarDni);
                        echo $resultado;
                    }
                    ?>
                </div>
